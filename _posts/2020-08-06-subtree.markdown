...
![Rerooting](/assets/difference_between_maximum_and_minimum_price_sum.png)

Rerooting is a general algorithm that can be used in many cases. However, a smarter approach is to use a one-pass [DFS](../../../2020/08/20/tree-recursion.html).
